...
require $argv[1].'/api/runtime.php';
$pdo=db();
...
<?php
declare(strict_types=1);
$root=$argv[1];require $root.'/api/composition-store.php';
...
echo json_encode(['ok'=>true,'preset'=>$key,'schema'=>9],JSON_PRETTY_PRINT|JSON_UNESCAPED_SLASHES),PHP_EOL;
PHP
...
PY
echo 'PASS: schema-v9 migration and governed composition rehearsal'
