...
function onboardingState(string $root): array {
    ...
    $steps[]=onboardingStep('pages','Shape the starter pages',$authority?'ready':'blocked',$authority?'Edit starter copy or compose additional pages from trusted repository templates.':'Initialize canonical page content first.','/cms/pages.php','Edit pages',false);
